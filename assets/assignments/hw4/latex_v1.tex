...
\begin{questions} 
    ...
    \newpage
    \question Here are the results of three classifier ensembles, where $C$ denotes the base classifier and $C^*$ denotes the ensemble result. The three subplots correspond to three typical error distribution patterns of base classifiers.
        \begin{table}[!h]
        \centering
